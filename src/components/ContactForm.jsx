  ...
  return (
    ...
    >
      ...
      <div className="form-field-group grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div>
          <label className={LABEL}>
            WEBSITE OR COMPANY URL (OPTIONAL)
          </label>
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="+91 98765 43210 / +1 555 123 4567"
            className={INPUT}
          />
        </div>
      ...
      <div className="form-field-group">
        ...
        <textarea
          ...
          required
          rows="4"
          placeholder="Tell us about your project, goals, budget range, timeline, and how we can help you build something impactful..."
          className="w-full resize-none rounded-md border border-[#e8e2d7] bg-[#fcfaf7] p-4 font-sans text-sm text-[#141311] outline-none transition placeholder:text-neutral-400 focus:border-[#d99b4b] focus:ring-1 focus:ring-[#d99b4b]"
        />
      ...
      {showSuccess && (
        <div
          ref={successRef}
          className="flex items-start space-x-3 rounded-lg border border-amber-300/80 bg-amber-50/70 p-4 text-xs text-amber-900"
        >
      ...
      <div className="form-field-group flex flex-col items-center justify-between gap-2 border-t border-neutral-100 pt-4 text-[11px] text-neutral-400 sm:flex-row">
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <span>
            Protected by mutual confidentiality. Strict zero-spam policy.
          </span>
        </div>
